...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(to bottom right, #E9EDF2, #ffffff)' }}>
      <div className="relative bg-white/95 backdrop-blur-sm p-10 rounded-2xl shadow-2xl w-full max-w-md border-2" style={{ borderColor: '#D2D7E1' }}>
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl mb-6 shadow-lg" style={{ background: 'linear-gradient(135deg, #004B9B 0%, #00BCFA 100%)' }}>
          ...
          <p className="text-base font-medium" style={{ color: '#141E32' }}>Meeting Room Management System</p>
        </div>

        {registered && (
          <div className="mb-5 p-4 rounded-lg" style={{ backgroundColor: '#A6E1FF', borderLeft: '4px solid #00BCFA' }}>
            <div className="flex items-center">
              <svg className="w-5 h-5 mr-2" style={{ color: '#004B9B' }} fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <p className="font-medium text-sm" style={{ color: '#004B9B' }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full text-white py-3.5 px-4 rounded-full font-bold focus:outline-none focus:ring-4 transform transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg hover:shadow-xl"
        ...
        <div className="mt-6 text-center">
          <p className="text-sm" style={{ color: '#141E32' }}>
            ...
            <Link href="/auth/signup" className="font-semibold hover:underline" style={{ color: '#000032' }}>
              Sign up
            </Link>
          </p>
        </div>
